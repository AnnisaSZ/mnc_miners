...
class ActHauling(models.Model):
    ...
    validation_plan = fields.One2many('validation.plan', 'validation_act_hauling_id', string='Validation',
    ...
    def create(self, vals):
        res = super(ActHauling, self).create(vals)
        seq = self.env['ir.sequence'].next_by_code('act.hauling')
    ...
    def set_validation(self):
        ...
        if bu_id:
            ...
            if validation:
                ...
                raise UserError('Validation untuk Form Hauling belum disetting')
