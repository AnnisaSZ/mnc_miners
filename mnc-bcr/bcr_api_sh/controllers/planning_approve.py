...
class BcrInterfacePlanningApprove(http.Controller):
    @http.route('/api/planning/hauling/approve', type='json', auth="public", csrf=False)
    def getDataPlanningHaulingApprove(self, values=None):
            ...
            if key == api_key:
                ...
                if datas:
                    ...
                    if hauling_data:
                        ...
                        # src_usr_val = BcrInterfaceNotification.search_usr_validation_by_model("validation_planning_hauling_id","planning.hauling")
    ...
    @http.route('/api/planning/barging/approve', type='json', auth="public", csrf=False)
    def getDataPlanningBargingApprove(self, values=None):
        if request.httprequest.headers.get('Api-key'):
            key = request.httprequest.headers.get('Api-key')
            api_key = get_api_key(self)
            # if key == APIKEY:
    ...
    @http.route('/api/planning/production/approve', type='json', auth="public", csrf=False)
    def getDataPlanningProductionApprove(self, values=None):
        if request.httprequest.headers.get('Api-key'):
            key = request.httprequest.headers.get('Api-key')
            api_key = get_api_key(self)
            # if key == APIKEY:
